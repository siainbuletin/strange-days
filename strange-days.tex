...
\begin{description}
	\item[scoptofilie] gr. \dedouble skopós\sqtworight (privitor) + gr. \dedouble philía\sqtworight (iubire) \par
 patologie: Dependența (sexuală) de a observa deschis acte sexuale fără jenă (spre deosebire de voyeurism) \par
\end{description}
