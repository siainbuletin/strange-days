...
\begin{document}
	...
	\begin{description}
		\item[scoptofilie] gr. \begin{greek}[variant=ancient] σκοπός \end{greek} (skopós, \dedouble privitor\sqtworight) +‎ \begin{greek}[variant=ancient] φιλία \end{greek} (philía, \dedouble iubire\sqtworight)\par
